...
I am a Computer Science Engineering student at BIT Mesra, currently holding a <span className='italic text-xl text-gradient'>Specialist rank on Codeforces (Max Rating: 1410)</span> and <span className='italic text-xl text-gradient'>3 star at Codechef (Max Rating: 1785)</span>.
